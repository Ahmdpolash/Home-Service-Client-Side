...
const Nav = () => {
  ...
  return (
    <div className="px-3 lg:px-16 py-2 bg-[#F3F3F3]">
      <Navbar fluid rounded className="bg-[#F3F3F3]">
        <Navbar.Brand href="https://flowbite-react.com">
          <img src="/favicon.svg" className="mr-3 h-6 sm:h-9" alt="" />
          <span className="self-center whitespace-nowrap text-xl font-semibold dark:text-white">
            <img className="w-[180px]" src="https://demo.creativemox.com/beclean/wp-content/uploads/sites/2/2023/09/Logo_BeClean_1.png" alt="" />
          </span>
        </Navbar.Brand>
        ...
        <div className="flex gap-4 md:order-2">
          ...
          {user?.email ? (
            ...
            <Link to="/login">
              <button onClick={handleLogOut} className="bg-[#2E856E] text-white py-2 px-5 font-semibold rounded-md ">
                Login
              </button>
            </Link>
          )}
