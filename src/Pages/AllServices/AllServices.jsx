...
const AllServices = () => {
  ...
  return (
    <div classNameName="h-[60vh] lg:px-16 py-8">
      ...
      {data
        ?.filter((service) => {
          return service.service_name.toLowerCase() === search.toLowerCase()
        })
        ?.map((service) => (
          <div className="px-4 lg:px-16">
            <div class="relative flex flex-col mb-5 lg:h-[270px] w-full border lg:flex-row rounded-xl bg-white bg-clip-border text-gray-700 shadow-lg">
              <div class="relative lg:w-2/5 overflow-hidden text-gray-700 bg-white rounded-r-none shrink-0 rounded-xl bg-clip-border">
                <img
                  ...
                  alt="image"
                  className="object-cover h-full lg:h-[270px] w-full "
                />
              </div>
              <div class="px-6 py-2">
                <div className="flex justify-between items-center">
                  ...
                  <h1>{service.provider_location}</h1>
                  <div className="ml-2">
                    <span className="bg-red-200 px-2 lg:px-5 -mr-[px] lg:-mr-[20px] py-2 font-bold">
                      Price : {service.price}
                    </span>
                  </div>
                </div>
